...
vlog -work msim -64 -incr -sv "+incdir+../src/" "../src/axi_pkg.sv"
vlog -work msim -64 -incr -sv "+incdir+../src/" "../src/adv7393_pkg.sv"
vlog -work msim -64 -incr -sv "+incdir+../src/" "../src/axi_master_rd.sv"
vlog -work msim -64 -incr -sv "+incdir+../src/" "../src/adv7393_frame_ctrl.sv"
vlog -work msim -64 -incr -sv "+incdir+../src/" "../src/adv7393_interface.sv"
vlog -work msim -64 -incr -sv "+incdir+../src/" "../src/adv7393_sync_gen.sv"
vlog -work msim -64 -incr -sv "+incdir+../src/" "../src/adv7393_line_buffer.sv"
...
vlog -work msim -64 -incr -sv "+incdir+../src/import" "../src/import/cdn_axi4_slave_bfm.sv"
